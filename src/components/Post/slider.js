...
import _react, { PureComponent } from "react";var _react2=_interopRequireDefault(_react);



import { Easing, Animated, Image, PanResponder, View, ViewPropTypes, StyleSheet } from "react-native";
...
allMeasured:false,
value:new Animated.Value(_this.props.value)},_this.
...
{toValue:value});
     ...
     Animated[animationType](_this.state.value,animationConfig).start();},_this.
...
return false;}}]);return Slider;}(PureComponent);Slider.propTypes={ /**
     ...
     */animationConfig:_propTypes2.default.object};Slider.defaultProps={value:0,minimumValue:0,maximumValue:1,step:0,minimumTrackTintColor:'#3f3f3f',maximumTrackTintColor:'#b3b3b3',thumbTintColor:'#343434',thumbTouchSize:{width:40,height:40},debugTouchArea:false,animationType:'timing'};const _default = Slider;
export { _default as default };var defaultStyles=StyleSheet.create({container:{height:40,justifyContent:'center'},track:{height:TRACK_SIZE,borderRadius:TRACK_SIZE/2},thumb:{position:'absolute',width:THUMB_SIZE,height:THUMB_SIZE,borderRadius:THUMB_SIZE/2},touchArea:{position:'absolute',backgroundColor:'transparent',top:0,left:0,right:0,bottom:0},debugThumbTouchArea:{position:'absolute',backgroundColor:'green',opacity:0.5}});